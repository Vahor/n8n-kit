...
export interface AwsRekognitionNodeParameters {
    ...
    /** Default: {} */
    readonly additionalFields?: { regionsOfInterestUi?: { regionsOfInterestValues: { height?: number, left?: number, top?: number, Width?: number } }, version?: string, wordFilterUi?: { MinBoundingBoxHeight?: number, MinBoundingBoxWidth?: number, MinConfidence?: number }, maxLabels?: number, minConfidence?: number, attributes?: ("all" | "default")[] };
