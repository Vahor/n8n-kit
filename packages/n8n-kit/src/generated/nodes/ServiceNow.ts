...
export interface ServiceNowNodeParameters {
    ...
    /** Default: {} */
    readonly options?: { file_name?: string } | { queryFilter?: string } | { sysparm_exclude_reference_link?: boolean, sysparm_fields?: unknown[], sysparm_query?: string, sysparm_display_value?: "false" | "all" | "true" } | { sysparm_exclude_reference_link?: boolean, sysparm_fields?: unknown[], sysparm_display_value?: "false" | "all" | "true" };
    ...
    /** Default: {} */
    readonly additionalFields?: { assigned_to?: string, assignment_group?: string, business_service?: string, caller_id?: string, category?: string, close_notes?: string, cmdb_ci?: unknown[], contact_type?: "email" | "phone" | "self-service" | "walk-in", description?: string, impact?: 3 | 2 | 1, close_code?: string, state?: string, subcategory?: string, urgency?: 3 | 2 | 1 } | { active?: boolean, building?: string, city?: string, company?: string, country?: string, department?: string, email?: string, first_name?: string, gender?: string, home_phone?: string, last_name?: string, location?: string, manager?: string, middle_name?: string, mobile_phone?: string, user_password?: string, password_needs_reset?: boolean, phone?: string, roles?: unknown[], source?: string, state?: string, street?: string, user_name?: string, zip?: string };

    /** Default: {} */
    readonly updateFields?: { assigned_to?: string, assignment_group?: string, business_service?: string, caller_id?: string, category?: string, close_notes?: string, cmdb_ci?: unknown[], contact_type?: "email" | "phone" | "self-service" | "walk-in", description?: string, impact?: 3 | 2 | 1, close_code?: string, hold_reason?: string, state?: string, subcategory?: string, urgency?: 3 | 2 | 1, work_notes?: string } | { active?: boolean, building?: string, city?: string, company?: string, country?: string, department?: string, email?: string, first_name?: string, gender?: string, home_phone?: string, last_name?: string, location?: string, manager?: string, middle_name?: string, mobile_phone?: string, user_password?: string, password_needs_reset?: boolean, phone?: string, roles?: unknown[], source?: string, state?: string, street?: string, user_name?: string, zip?: string };
