...
export interface GmailV1NodeParameters {
    ...
    /** Default: {} */
    readonly additionalFields?: { toList?: string, ccList?: string, bccList?: string, attachmentsUi?: { attachmentsBinary: { property?: string } } } | { dataPropertyAttachmentsPrefixName?: string, format?: "full" | "metadata" | "minimal" | "raw" | "resolved" } | { dataPropertyAttachmentsPrefixName?: string, format?: "full" | "ids" | "metadata" | "minimal" | "raw" | "resolved", includeSpamTrash?: boolean } | { attachmentsUi?: { attachmentsBinary: { property?: string } }, bccList?: string, ccList?: string, senderName?: string } | { format?: "full" | "metadata" | "minimal" | "raw" | "resolved", dataPropertyAttachmentsPrefixName?: string } | { dataPropertyAttachmentsPrefixName?: string, format?: "full" | "ids" | "metadata" | "minimal" | "raw" | "resolved", includeSpamTrash?: boolean, labelIds?: any[], q?: string };
