...
export interface HubspotV1NodeParameters {
     ...
     */
    readonly filterGroupsUi?: { filterGroupsValues: { filtersUi?: { filterValues: { propertyName?: string, operator?: "CONTAINS_TOKEN" | "EQ" | "GT" | "GTE" | "HAS_PROPERTY" | "NOT_HAS_PROPERTY" | "LT" | "LTE" | "NEQ", value?: string } } } };
     ...
     * Type options: {"multipleValues":false}
     */
    readonly lengalConsentUi?: { lengalConsentValues: { consentToProcess?: boolean, text?: string, communicationsUi?: { communicationValues: { subscriptionTypeId?: string, value?: boolean, text?: string } } }, legitimateInterestValues: { subscriptionTypeId?: string, value?: boolean, legalBasis?: "CUSTOMER" | "LEAD", text?: string } };
