...
export interface HighLevelV1NodeParameters {
    ...
    /** Default: {} */
    readonly additionalFields?: { address1?: string, city?: string, customFields?: { values: Array<{ fieldId: string, fieldValue?: string }> }, dnd?: boolean, firstName?: string, lastName?: string, name?: string, postalCode?: string, source?: string, state?: string, tags?: string, timezone?: string, website?: string } | { assignedTo?: string, companyName?: string, monetaryValue?: number, name?: string, tags?: string } | { assignedTo?: string, description?: string, status?: "incompleted" | "completed" };

    readonly contactId?: string;

    /** Default: {} */
    readonly updateFields?: { address1?: string, city?: string, customFields?: { values: Array<{ fieldId: string, fieldValue?: string }> }, dnd?: boolean, email?: string, firstName?: string, lastName?: string, name?: string, phone?: string, postalCode?: string, state?: string, tags?: string, timezone?: string, website?: string } | { assignedTo?: string, companyName?: string, contactIdentifier?: string, monetaryValue?: number, name?: string, stageId?: string, status?: "open" | "won" | "lost" | "abandoned", title?: string, tags?: string } | { assignedTo?: string, description?: string, dueDate?: string, status?: "incompleted" | "completed", title?: string };
