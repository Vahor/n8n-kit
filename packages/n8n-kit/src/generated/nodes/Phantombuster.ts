...
export interface PhantombusterNodeParameters {
    ...
    /** Default: {} */
    readonly additionalFields?: { prevContainerId?: string, prevStatus?: "finished" | "lauch error" | "never launched" | "running" | "starting" | "unknown", prevRuntimeEventIndex?: number } | { argumentsJson?: string, argumentsUi?: { argumentValues: Array<{ key?: string, value?: string }> }, bonusArgumentUi?: { bonusArgumentValue: Array<{ key?: string, value?: string }> }, bonusArgumentJson?: string, manualLaunch?: boolean, maxInstanceCount?: number, saveArgument?: string };
