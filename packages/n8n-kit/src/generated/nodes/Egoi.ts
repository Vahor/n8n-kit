...
export interface EgoiNodeParameters {
    ...
    /** Default: {} */
    readonly additionalFields?: { birth_date?: string, cellphone?: string, extraFieldsUi?: { extraFieldValues: { field_id?: string, value?: string } }, first_name?: string, last_name?: string, status?: "unconfirmed" | "active" | "inactive" | "removed", tagIds?: any[] };

    /** Default: {} */
    readonly updateFields?: { birth_date?: string, cellphone?: string, email?: string, extraFieldsUi?: { extraFieldValues: { field_id?: string, value?: string } }, first_name?: string, last_name?: string, status?: "unconfirmed" | "active" | "inactive" | "removed", tagIds?: any[] };
