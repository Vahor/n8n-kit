...
export interface ClockifyNodeParameters {
     ...
     * Default: {}
     */
    readonly additionalFields?: { "archived"?: boolean, "name"?: string, "sort-order"?: "ASCENDING" | "DESCENDING" } | { "billable"?: boolean, "color"?: any, "clientId"?: string, "estimateUi"?: { "estimateValues": any }, "isPublic"?: boolean, "note"?: string } | { "archived"?: boolean, "billable"?: boolean, "clients"?: any[], "contains-client"?: boolean, "client-status"?: "ACTIVE" | "ARCHIVED", "contains-user"?: boolean, "is-template"?: boolean, "name"?: string, "sort-column"?: "NAME" | "CLIENT_NAME" | "DURATION", "sort-order"?: "ASCENDING" | "DESCENDING", "users"?: string, "user-status"?: "ACTIVE" | "ARCHIVED" } | { "archived"?: boolean, "name"?: string, "sort-column"?: "NAME", "sort-order"?: "ASCENDING" | "DESCENDING" } | { "assigneeIds"?: any[], "estimate"?: string } | { "email"?: string, "name"?: string, "status"?: "ACTIVE" | "INACTIVE" | "PENDING" | "DECLINED", "sort-column"?: "EMAIL" | "NAME" | "HOURLYRATE", "sort-order"?: "ASCENDING" | "DESCENDING" } | { "billable"?: boolean, "customFieldsUi"?: { "customFieldsValues": any }, "description"?: string, "end"?: string, "projectId"?: string, "tagIds"?: any[], "taskId"?: string } | { "consider-duration-format"?: boolean, "hydrated"?: boolean };
