...
export interface ChargebeeNodeParameters {
     ...
     * Default: {}
     */
    readonly properties?: { id?: string, first_name?: string, last_name?: string, email?: string, phone?: string, company?: string, customProperties?: { property: Array<{ name?: string, value?: string }> } };
     ...
     */
    readonly filters?: { date: Array<{ operation?: "is" | "is_not" | "after" | "before", value?: string }>, total: Array<{ operation?: "gte" | "gt" | "is" | "is_not" | "lte" | "lt", value?: number }> };
