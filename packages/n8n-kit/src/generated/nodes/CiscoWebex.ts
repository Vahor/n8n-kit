...
export interface CiscoWebexNodeParameters {
    ...
    /** Default: {} */
    readonly updateFields?: { agenda?: string, allowAnyUserToBeCoHost?: boolean, allowAuthenticatedDevices?: boolean, allowFirstUserToBeCoHost?: boolean, enableConnectAudioBeforeHost?: boolean, enabledAutoRecordMeeting?: boolean, enabledJoinBeforeHost?: boolean, end?: string, excludePassword?: boolean, hostEmail?: string, inviteesUi?: { inviteeValues: Array<{ email: string, displayName?: string, coHost?: boolean }> }, joinBeforeHostMinutes?: 0 | 5 | 10 | 15, password?: string, publicMeeting?: boolean, recurrence?: string, requireRegistrationInfo?: ("requireFirstName" | "requireLastName" | "requireEmail" | "requireJobTitle" | "requireCompanyName" | "requireAddress1" | "requireAddress2" | "requireCity" | "requireState" | "requireZipCode" | "requireCountryRegion" | "requireWorkPhone" | "requireFax")[], reminderTime?: number, sendEmail?: boolean, siteUrl?: string, start?: string, title?: string };
