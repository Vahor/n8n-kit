...
export interface VectorStoreMongoDBAtlasNodeParameters {
    ...
    /** Default: {} */
    readonly options?: { clearNamespace?: boolean, namespace?: string } | { namespace?: string, metadata?: { metadataValues: Array<{ name: string, value?: string }> }, preFilter: string, postFilterPipeline: string };
