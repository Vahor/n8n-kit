...
export interface SupabaseNodeParameters {
     ...
     */
    readonly filters?: { conditions: Array<{ keyName?: string, condition?: "eq" | "fullText" | "gt" | "gte" | "ilike" | "is" | "lt" | "lte" | "like" | "neq", searchFunction?: "fts" | "plfts" | "phfts" | "wfts", keyValue?: string }> } | { conditions: Array<{ keyName?: string, keyValue?: string }> };
