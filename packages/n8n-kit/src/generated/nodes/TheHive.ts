...
export interface TheHiveNodeParameters {
     ...
     */
    readonly artifactUi?: { artifactValues: Array<{ dataType?: string, data?: string, binaryProperty?: string, message?: string, tags?: string }> };
    ...
    /** Default: {} */
    readonly additionalFields?: { caseTemplate?: string, customFieldsUi?: { customFields: Array<{ field?: string, value?: string }> }, customFieldsJson?: string } | { caseTemplate?: string };

    /** Default: {} */
    readonly updateFields?: { artifactUi?: { artifactValues: Array<{ dataType?: string, data?: string, binaryProperty?: string, message?: string, tags?: string }> }, customFieldsUi?: { customFields: Array<{ field?: string, value?: string }> }, customFieldsJson?: string, caseTemplate?: string, description?: string, follow?: boolean, severity?: 1 | 2 | 3, status?: "New" | "Updated" | "Ignored" | "Imported", tags?: string, title?: string, tlp?: 0 | 1 | 2 | 3 } | { message?: string, tags?: string, tlp?: 0 | 1 | 2 | 3, ioc?: boolean, sighted?: boolean, status?: "Ok" | "Deleted" } | { customFieldsUi?: { customFields: Array<{ field?: string, value?: string }> }, customFieldsJson?: string, description?: string, endDate?: string, flag?: boolean, impactStatus?: "NoImpact" | "WithImpact" | "NotApplicable", metrics?: string, owner?: string, resolutionStatus?: "Duplicated" | "FalsePositive" | "Indeterminate" | "Other" | "TruePositive", severity?: 1 | 2 | 3, startDate?: string, status?: "Open" | "Resolved" | "Deleted", summary?: string, tags?: string, title?: string, tlp?: 0 | 1 | 2 | 3 } | { description?: string, endDate?: string, flag?: boolean, owner?: string, startDate?: string, status?: "Cancel" | "Completed" | "InProgress" | "Waiting", title?: string };
