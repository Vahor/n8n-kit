...
export interface Magento2NodeParameters {
    ...
    /** Default: {} */
    readonly additionalFields?: { addresses?: { address: { street: string, city: string, region?: string, postcode: string, country_id: string, company?: string, fax?: string, firstname: string, lastname: string, middlename?: string, prefix?: string, suffix?: string, telephone: string, default_billing?: boolean, default_shipping?: boolean } }, amazon_id?: string, confirmation?: string, customAttributes?: { customAttribute: { attribute_code?: string, value?: string } }, dob?: string, default_billing?: string, default_shipping?: string, gender?: 1 | 2 | 3, group_id?: string, is_subscribed?: boolean, middlename?: string, password?: string, prefix?: string, store_id?: string, suffix?: string, vertex_customer_code?: string, vertex_customer_country?: string, website_id?: string } | { attribute_set_id?: string, name?: string, price?: number, status?: 1 | 2, type_id?: string, visibility?: 1 | 2 | 3 | 4, weight?: number };
    ...
    /** Default: {} */
    readonly updateFields?: { addresses?: { address: { street: string, city: string, region?: string, postcode: string, country_id: string, company?: string, fax?: string, firstname: string, lastname: string, middlename?: string, prefix?: string, suffix?: string, telephone: string, default_billing?: boolean, default_shipping?: boolean } }, amazon_id?: string, confirmation?: string, customAttributes?: { customAttribute: { attribute_code?: string, value?: string } }, dob?: string, default_billing?: string, default_shipping?: string, gender?: 1 | 2 | 3, group_id?: string, is_subscribed?: boolean, middlename?: string, password?: string, prefix?: string, store_id?: string, suffix?: string, vertex_customer_code?: string, vertex_customer_country?: string, website_id?: string } | { attribute_set_id?: string, name?: string, price?: number, status?: 1 | 2, type_id?: string, visibility?: 1 | 2 | 3 | 4, weight?: number };
     ...
     */
    readonly filters?: { conditions: { field?: string, condition_type?: "eq" | "gt" | "gteq" | "in" | "lt" | "lte" | "like" | "moreq" | "neq" | "nin" | "notnull" | "null", value?: string } };
