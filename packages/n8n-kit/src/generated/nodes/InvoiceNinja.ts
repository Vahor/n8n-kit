...
export interface InvoiceNinjaNodeParameters {
     ...
     */
    readonly billingAddressUi?: { billingAddressValue: { streetAddress?: string, aptSuite?: string, city?: string, state?: string, postalCode?: string, countryCode?: string } };
     ...
     * Type options: {"multipleValues":false}
     */
    readonly shippingAddressUi?: { shippingAddressValue: { streetAddress?: string, aptSuite?: string, city?: string, state?: string, postalCode?: string, countryCode?: string } };
