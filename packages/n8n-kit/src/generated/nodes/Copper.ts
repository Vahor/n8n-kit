...
export interface CopperNodeParameters {
    ...
    /** Default: {} */
    readonly additionalFields?: { address?: { addressFields: { street?: string, city?: string, state?: string, postal_code?: string, country?: string } }, details?: string, email_domain?: string, phone_numbers?: { phoneFields: Array<{ number?: string, category?: string }> } } | { address?: { addressFields: { street?: string, city?: string, state?: string, postal_code?: string, country?: string } }, email?: { emailFields: { email?: string, category?: string } }, phone_numbers?: { phoneFields: Array<{ number?: string, category?: string }> } } | { address?: { addressFields: { street?: string, city?: string, state?: string, postal_code?: string, country?: string } }, details?: string, email_domain?: string, emails?: { emailFields: Array<{ email?: string, category?: string }> }, phone_numbers?: { phoneFields: Array<{ number?: string, category?: string }> } } | { assignee_id?: string, details?: string, status?: "Completed" | "Open" } | { assignee_id?: string, details?: string, priority?: "High" | "None", status?: "Completed" | "Open" };
    ...
    /** Default: {} */
    readonly updateFields?: { address?: { addressFields: { street?: string, city?: string, state?: string, postal_code?: string, country?: string } }, details?: string, name?: string, phone_numbers?: { phoneFields: Array<{ number?: string, category?: string }> } } | { address?: { addressFields: { street?: string, city?: string, state?: string, postal_code?: string, country?: string } }, details?: string, email?: { emailFields: { email?: string, category?: string } }, name?: string, phone_numbers?: { phoneFields: Array<{ number?: string, category?: string }> } } | { customer_source_id?: string, name?: string, primary_contact_id?: string } | { address?: { addressFields: { street?: string, city?: string, state?: string, postal_code?: string, country?: string } }, details?: string, email_domain?: string, emails?: { emailFields: Array<{ email?: string, category?: string }> }, name?: string, phone_numbers?: { phoneFields: Array<{ number?: string, category?: string }> } } | { assignee_id?: string, details?: string, name?: string, status?: "Completed" | "Open" } | { assignee_id?: string, details?: string, name?: string, priority?: "High" | "None", status?: "Completed" | "Open" };
