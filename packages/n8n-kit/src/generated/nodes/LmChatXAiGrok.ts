...
export interface LmChatXAiGrokNodeParameters {
     ...
     * Default: {}
     */
    readonly options?: { frequencyPenalty?: number, maxTokens?: number, responseFormat?: "text" | "json_object", presencePenalty?: number, temperature?: number, timeout?: number, maxRetries?: number, topP?: number, priority?: boolean, reasoning?: "none" | "low" | "medium" | "high" };
