...
export interface ClickUpNodeParameters {
    ...
    /** Default: {} */
    readonly updateFields?: { name?: string, position?: number } | { assignee?: string, name?: string, parent?: string, resolved?: boolean } | { assignee?: string, commentText?: string, resolved?: boolean } | { name?: string } | { addOwners?: string, color?: string, description?: string, dueDate?: string, name?: string, removeOwners?: string } | { name?: string, note?: string, stepsCurrent?: number, stepsEnd?: number, stepsStart?: number, unit?: string } | { addAssignees?: string, content?: string, dueDate?: string, dueDateTime?: boolean, markdownContent?: boolean, name?: string, notifyAll?: boolean, parentId?: string, priority?: number, removeAssignees?: string, status?: string, startDate?: string, startDateTime?: boolean, timeEstimate?: number } | { assignee?: string, billable?: boolean, description?: string, duration?: number, start?: string, tags?: unknown[], task?: string } | { assignee?: string, content?: string, dueDate?: string, dueDateTime?: boolean, name?: string, priority?: number, unsetStatus?: boolean };

    /** Default: {} */
    readonly additionalFields?: { assignee?: string } | { assignee?: string, notifyAll?: boolean } | { color?: string, description?: string, dueDate?: string, multipleOwners?: boolean, owners?: string } | { listIds?: string, owners?: string, stepsStart?: number, stepsEnd?: number, taskIds?: string, unit?: string } | { custom_task_ids?: boolean, team_id?: string } | { assignees?: unknown[], customFieldsJson?: string, content?: string, dueDate?: string, dueDateTime?: boolean, markdownContent?: boolean, notifyAll?: boolean, parentId?: string, priority?: number, startDate?: string, startDateTime?: boolean, status?: string, tags?: unknown[], timeEstimate?: number } | { assignee?: string, billable?: boolean, description?: string, tags?: unknown[] } | { billable?: boolean, description?: string } | { assignee?: string, content?: string, dueDate?: string, dueDateTime?: boolean, priority?: number, status?: string };
    ...
    /** Default: {} */
    readonly filters?: { archived?: boolean } | { archived?: boolean, assignees?: unknown[], customFieldsUi?: { customFieldsValues: Array<{ fieldId?: string, operator?: "!=" | "<" | "<=" | ">" | ">=" | "equal" | "IS NOT NULL" | "IS NULL", value?: string }> }, dateCreatedGt?: string, dateCreatedLt?: string, dateUpdatedGt?: string, dateUpdatedLt?: string, dueDateGt?: string, dueDateLt?: string, includeClosed?: boolean, orderBy?: "id" | "created" | "updated" | "dueDate", statuses?: unknown[], subtasks?: boolean, tags?: unknown[] } | { end_date?: string, start_date?: string };
