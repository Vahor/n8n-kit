...
export interface YouTubeNodeParameters {
    ...
    /** Default: {} */
    readonly updateFields?: { brandingSettingsUi?: { channelSettingsValues: { channel?: { country?: string, description?: string, defaultLanguage?: string, defaultTab?: string, featuredChannelsTitle?: string, featuredChannelsUrls?: string, keywords?: string, moderateComments?: boolean, profileColor?: string, showRelatedChannels?: boolean, showBrowseView?: boolean, trackingAnalyticsAccountId?: string, unsubscribedTrailer?: string } }, imageSettingsValues: { image?: { bannerExternalUrl?: string, trackingImageUrl?: string, watchIconImageUrl?: string } }, statusValue: { status?: { selfDeclaredMadeForKids?: boolean } } }, onBehalfOfContentOwner?: string } | { defaultLanguage?: string, description?: string, onBehalfOfContentOwner?: string, privacyStatus?: "private" | "public" | "unlisted", tags?: string } | { defaultLanguage?: string, description?: string, embeddable?: boolean, license?: "creativeCommon" | "youtube", notifySubscribers?: boolean, privacyStatus?: "private" | "public" | "unlistef", publicStatsViewable?: boolean, publishAt?: string, recordingDate?: string, selfDeclaredMadeForKids?: boolean, tags?: string };
