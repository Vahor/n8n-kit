...
export interface BubbleNodeParameters {
     ...
     */
    readonly properties?: { property: Array<{ key?: string, value?: string }> };
    ...
    /** Default: {} */
    readonly options?: { filters?: { filter: Array<{ key?: string, constraint_type?: "equals" | "not equal" | "is_empty" | "is_not_empty" | "text contains" | "not text contains" | "greater than" | "less than" | "in" | "not in" | "contains" | "not contains" | "empty" | "not empty" | "geographic_search", value?: string }> }, filtersJson?: string, sort?: { sortValue: { sort_field?: string, descending?: boolean, geo_reference?: string } } };
