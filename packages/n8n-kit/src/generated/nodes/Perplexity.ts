...
export const description = " AI-powered answer engine that provides accurate, trusted, and real-time answers to any question. Generates AI responses with citations" as const;
