...
export const credentials = [{"displayName":"Credentials to Connect to Jira","name":"jiraSoftwareCloudApi","required":true,"displayOptions":{"show":{"jiraVersion":["cloud"]}}},{"displayName":"Credentials to Connect to Jira","name":"jiraSoftwareServerApi","required":true,"displayOptions":{"show":{"jiraVersion":["server"]}}},{"displayName":"Credentials to Connect to Jira","name":"jiraSoftwareServerPatApi","required":true,"displayOptions":{"show":{"jiraVersion":["serverPat"]}}},{"displayName":"Credentials to Connect to Jira","name":"jiraSoftwareCloudOAuth2Api","required":true,"displayOptions":{"show":{"jiraVersion":["cloudOAuth2"]}}},{"name":"httpQueryAuth","displayName":"Credentials to Authenticate Webhook","displayOptions":{"show":{"authenticateWebhook":[true]}}},{"name":"httpQueryAuth","displayName":"Credentials to Authenticate Webhook","displayOptions":{"show":{"incomingAuthentication":["queryAuth"]}}}] as const;
...
export interface JiraTriggerNodeParameters {
     ...
     * Default: []
     */
    readonly events?: ("*" | "board_configuration_changed" | "board_created" | "board_deleted" | "board_updated" | "comment_created" | "comment_deleted" | "comment_updated" | "jira:issue_created" | "jira:issue_deleted" | "issuelink_created" | "issuelink_deleted" | "jira:issue_updated" | "option_attachments_changed" | "option_issuelinks_changed" | "option_subtasks_changed" | "option_timetracking_changed" | "option_unassigned_issues_changed" | "option_voting_changed" | "option_watching_changed" | "project_created" | "project_deleted" | "project_updated" | "sprint_closed" | "sprint_created" | "sprint_deleted" | "sprint_started" | "sprint_updated" | "user_created" | "user_deleted" | "user_updated" | "jira:version_created" | "jira:version_deleted" | "jira:version_moved" | "jira:version_released" | "jira:version_unreleased" | "jira:version_updated" | "worklog_created" | "worklog_deleted" | "worklog_updated")[] | ("*" | "comment_created" | "comment_deleted" | "comment_updated" | "jira:issue_created" | "jira:issue_deleted" | "issue_property_deleted" | "issue_property_set" | "jira:issue_updated" | "sprint_closed" | "sprint_created" | "sprint_deleted" | "sprint_started" | "sprint_updated" | "jira:version_created" | "jira:version_deleted" | "jira:version_merged" | "jira:version_moved" | "jira:version_released" | "jira:version_unreleased" | "jira:version_updated")[];
