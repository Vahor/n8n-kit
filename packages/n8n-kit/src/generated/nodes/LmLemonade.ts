...
// Generated from '/n8n/packages/@n8n/nodes-langchain/nodes/llms/LMLemonade/LmLemonade.node.ts' node

export const description = "Language Model Lemonade" as const;
export const type = "@n8n/n8n-nodes-langchain.lmLemonade" as const;
...
export interface LmLemonadeNodeParameters {
    /**
