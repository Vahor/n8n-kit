...
export interface VectorStoreWeaviateNodeParameters {
    ...
    /** Default: {} */
    readonly options?: { tenant?: string, textKey?: string, skip_init_checks?: boolean, timeout_init?: number, timeout_insert?: number, timeout_query?: number, proxy_grpc?: string, clearStore?: boolean } | { searchFilterJson?: string, metadataKeys?: string, hybridQuery?: string, hybridExplainScore?: boolean, fusionType?: "RelativeScore" | "Ranked", autoCutLimit?: number, alpha?: number, queryProperties?: string, maxVectorDistance?: number, tenant?: string, textKey?: string, skip_init_checks?: boolean, timeout_init?: number, timeout_insert?: number, timeout_query?: number, proxy_grpc?: string };
