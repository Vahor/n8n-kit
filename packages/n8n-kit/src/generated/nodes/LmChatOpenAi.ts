...
export interface LmChatOpenAiNodeParameters {
     ...
     * Default: {}
     */
    readonly options?: { baseURL?: string, frequencyPenalty?: number, maxTokens?: number, responseFormat?: "text" | "json_object", textFormat?: { textOptions: { type?: "text" | "json_schema" | "json_object", verbosity?: "low" | "medium" | "high", name?: string, requiredNotice?: string, schema?: string, description?: string, strict?: boolean } }, presencePenalty?: number, temperature?: number, reasoningEffort?: "low" | "medium" | "high", timeout?: number, maxRetries?: number, topP?: number, extraBody?: string, conversationId?: string, promptCacheKey?: string, safetyIdentifier?: string, serviceTier?: "auto" | "flex" | "default" | "priority", metadata?: string, topLogprobs?: number, promptConfig?: { promptOptions: { promptId?: string, version?: string, variables?: string } } };
