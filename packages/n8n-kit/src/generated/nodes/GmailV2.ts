...
export interface GmailV2NodeParameters {
    ...
    /** Default: {} */
    readonly options?: { attachmentsUi?: { attachmentsBinary: Array<{ property?: string }> }, bccList?: string, ccList?: string, fromAlias?: string, replyTo?: string, threadId?: string, sendTo?: string } | { dataPropertyAttachmentsPrefixName?: string, downloadAttachments?: boolean } | { dataPropertyAttachmentsPrefixName?: string, downloadAttachments?: boolean, includeSpamTrash?: boolean } | { labelListVisibility?: "labelHide" | "labelShow" | "labelShowIfUnread", messageListVisibility?: "hide" | "show" } | { appendAttribution?: boolean, attachmentsUi?: { attachmentsBinary: Array<{ property?: string }> }, bccList?: string, ccList?: string, senderName?: string, replyTo?: string, replyToSenderOnly?: boolean } | { limitWaitTime?: { values: { limitType?: "afterTimeInterval" | "atSpecifiedTime", resumeAmount?: number, resumeUnit?: "minutes" | "hours" | "days", maxDateAndTime?: string } }, appendAttribution?: boolean } | { messageButtonLabel?: string, responseFormTitle?: string, responseFormDescription?: string, responseFormButtonLabel?: string, responseFormCustomCss?: string, limitWaitTime?: { values: { limitType?: "afterTimeInterval" | "atSpecifiedTime", resumeAmount?: number, resumeUnit?: "minutes" | "hours" | "days", maxDateAndTime?: string } }, appendAttribution?: boolean } | { attachmentsUi?: { attachmentsBinary: Array<{ property?: string }> }, bccList?: string, ccList?: string, senderName?: string, replyToSenderOnly?: boolean, replyToRecipientsOnly?: boolean } | { returnOnlyMessages?: boolean };
