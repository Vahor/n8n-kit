...
export interface ShopifyNodeParameters {
    ...
    /** Default: {} */
    readonly updateFields?: { email?: string, locationId?: string, note?: string, shippingAddressUi?: { shippingAddressValues: { firstName?: string, lastName?: string, company?: string, country?: string, address1?: string, address2?: string, city?: string, province?: string, zip?: string, phone?: string } }, sourceName?: string, tags?: string } | { body_html?: string, handle?: string, images?: { created_at?: string, id?: number, position?: number, product_id?: number, variant_ids?: number, src?: string, width?: number, height?: number, updated_at?: string }, productOptions?: { option: { name?: string, value?: string } }, product_type?: string, published_at?: string, published_scope?: "global" | "web", tags?: string, template_suffix?: string, title?: string, vendor?: string };
