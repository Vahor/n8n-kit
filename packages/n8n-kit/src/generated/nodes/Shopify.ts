...
export interface ShopifyNodeParameters {
    ...
    /** Default: {} */
    readonly additionalFields?: { billingAddressUi?: { billingAddressValues: { firstName?: string, lastName?: string, company?: string, country?: string, address1?: string, address2?: string, city?: string, province?: string, zip?: string, phone?: string } }, discountCodesUi?: { discountCodesValues: Array<{ amount?: string, code?: string, type?: "fixedAmount" | "percentage" | "shipping" }> }, email?: string, fulfillmentStatus?: "fulfilled" | "null" | "partial" | "restocked", inventoryBehaviour?: "bypass" | "decrementIgnoringPolicy" | "decrementObeyingPolicy", locationId?: string, note?: string, sendFulfillmentReceipt?: boolean, sendReceipt?: boolean, shippingAddressUi?: { shippingAddressValues: { firstName?: string, lastName?: string, company?: string, country?: string, address1?: string, address2?: string, city?: string, province?: string, zip?: string, phone?: string } }, sourceName?: string, tags?: string, test?: boolean } | { body_html?: string, handle?: string, images?: { created_at?: string, id?: number, position?: number, product_id?: number, variant_ids?: number, src?: string, width?: number, height?: number, updated_at?: string }, productOptions?: { option: Array<{ name?: string, value?: string }> }, product_type?: string, published_at?: string, published_scope?: "global" | "web", tags?: string, template_suffix?: string, vendor?: string } | { fields?: string } | { collection_id?: string, created_at_max?: string, created_at_min?: string, fields?: string, handle?: string, ids?: string, presentment_currencies?: string, product_type?: string, published_at_max?: string, published_at_min?: string, published_status?: "any" | "published" | "unpublished", title?: string, updated_at_max?: string, updated_at_min?: string, vendor?: string };

    /**
     * Default: {}
     * Type options: {"multipleValues":true}
     */
    readonly limeItemsUi?: { lineItemValues: Array<{ productId?: string, variantId?: string, title?: string, grams?: string, quantity?: number, price?: string }> };
    ...
    /** Default: {} */
    readonly updateFields?: { email?: string, locationId?: string, note?: string, shippingAddressUi?: { shippingAddressValues: { firstName?: string, lastName?: string, company?: string, country?: string, address1?: string, address2?: string, city?: string, province?: string, zip?: string, phone?: string } }, sourceName?: string, tags?: string } | { body_html?: string, handle?: string, images?: { created_at?: string, id?: number, position?: number, product_id?: number, variant_ids?: number, src?: string, width?: number, height?: number, updated_at?: string }, productOptions?: { option: Array<{ name?: string, value?: string }> }, product_type?: string, published_at?: string, published_scope?: "global" | "web", tags?: string, template_suffix?: string, title?: string, vendor?: string };
