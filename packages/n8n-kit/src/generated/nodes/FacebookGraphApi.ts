...
export const credentials = [{"name":"facebookGraphApi","required":true,"displayOptions":{"show":{"authType":["accessToken"]}}},{"name":"facebookGraphApiOAuth2Api","required":true,"displayOptions":{"show":{"authType":["oAuth2"]}}}] as const;
...
export interface FacebookGraphApiNodeParameters {
    ...
    readonly graphApiVersion?: "" | "v25.0" | "v24.0" | "v23.0" | "v22.0" | "v21.0" | "v20.0" | "v19.0" | "v18.0" | "v17.0" | "v16.0" | "v15.0" | "v14.0" | "v13.0" | "v12.0" | "v11.0" | "v10.0" | "v9.0" | "v8.0" | "v7.0" | "v6.0" | "v5.0" | "v4.0" | "v3.3" | "v3.2" | "v3.1" | "v3.0";
