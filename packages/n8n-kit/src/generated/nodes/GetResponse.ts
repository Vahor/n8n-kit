...
export interface GetResponseNodeParameters {
    ...
    /** Default: {} */
    readonly additionalFields?: { customFieldsUi?: { customFieldValues: Array<{ customFieldId?: string, value?: string }> }, dayOfCycle?: string, ipAddress?: string, name?: string, note?: string, scoring?: number, tags?: unknown[] };
    ...
    /** Default: {} */
    readonly updateFields?: { campaignId?: string, customFieldsUi?: { customFieldValues: Array<{ customFieldId?: string, value?: string }> }, dayOfCycle?: string, email?: string, ipAddress?: string, name?: string, note?: string, scoring?: number, tags?: unknown[] };
