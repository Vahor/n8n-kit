...
export interface ToolHttpRequestNodeParameters {
     ...
     */
    readonly parametersQuery?: { values: { name?: string, valueProvider?: "modelRequired" | "modelOptional" | "fieldValue", value?: string } };
     ...
     * Type options: {"multipleValues":true}
     */
    readonly parametersHeaders?: { values: { name?: string, valueProvider?: "modelRequired" | "modelOptional" | "fieldValue", value?: string } };
     ...
     * Type options: {"multipleValues":true}
     */
    readonly parametersBody?: { values: { name?: string, valueProvider?: "modelRequired" | "modelOptional" | "fieldValue", value?: string } };
     ...
     * Type options: {"multipleValues":true}
     */
    readonly placeholderDefinitions?: { values: { name?: string, description?: string, type?: "not specified" | "string" | "number" | "boolean" | "json" } };
