...
export interface ActionNetworkNodeParameters {
    ...
    /** Default: {} */
    readonly additionalFields?: { browser_url?: string, description?: string, end_date?: string, featured_image_url?: string, instructions?: string, location?: { postal_addresses_fields: { primary?: boolean, address_lines?: string, locality?: string, region?: string, postal_code?: string, country?: string, language?: string, location?: { location_fields: { latitude?: string, longitude?: string } } } }, name?: string, start_date?: string } | { family_name?: string, given_name?: string, languages_spoken?: "da" | "nl" | "en" | "fi" | "fr" | "de" | "hu" | "id" | "ja" | "pt" | "br" | "ru" | "es" | "sv" | "tr" | "cy", phone_numbers?: { phone_numbers_fields: { number?: string, primary?: unknown, status?: "bouncing" | "previous bounce" | "subscribed" | "unsubscribed" } }, postal_addresses?: { postal_addresses_fields: Array<{ primary?: boolean, address_lines?: string, locality?: string, region?: string, postal_code?: string, country?: string, language?: string, location?: { location_fields: { latitude?: string, longitude?: string } } }> } } | { browser_url?: string, featured_image_url?: string, name?: string, petition_text?: string, target?: string } | { comments?: string };

    /**
     * Person’s email addresses
     * Default: {}
     */
    readonly email_addresses?: { email_addresses_fields: { address?: string, primary?: unknown, status?: "bouncing" | "previous bounce" | "previous spam complaint" | "spam complaint" | "subscribed" | "unsubscribed" } };

    /** Default: {} */
    readonly updateFields?: { family_name?: string, given_name?: string, languages_spoken?: "da" | "nl" | "en" | "fi" | "fr" | "de" | "hu" | "id" | "ja" | "pt" | "br" | "ru" | "es" | "sv" | "tr" | "cy", phone_numbers?: { phone_numbers_fields: { number?: string, primary?: unknown, status?: "bouncing" | "previous bounce" | "subscribed" | "unsubscribed" } }, postal_addresses?: { postal_addresses_fields: Array<{ primary?: boolean, address_lines?: string, locality?: string, region?: string, postal_code?: string, country?: string, language?: string, location?: { location_fields: { latitude?: string, longitude?: string } } }> } } | { browser_url?: string, featured_image_url?: string, name?: string, petition_text?: string, target?: string } | { comments?: string };
