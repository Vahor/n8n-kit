...
export interface ConvertKitNodeParameters {
    ...
    /** Default: {} */
    readonly additionalFields?: { fieldsUi?: { fieldsValues: Array<{ key?: string, value?: string }> }, firstName?: string } | { subscriberState?: "active" | "cancelled" } | { fieldsUi?: { fieldsValues: Array<{ key?: string, value?: string }> }, firstName?: string, tags?: unknown[] } | { fields?: { field: Array<{ key?: string, value?: string }> }, firstName?: string };
