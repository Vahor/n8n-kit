...
export interface SpreadsheetFileV2NodeParameters {
    ...
    /** Default: {} */
    readonly options?: { delimiter?: string, encoding?: "ascii" | "latin1" | "ucs-2" | "ucs2" | "utf-8" | "utf16le" | "utf8", enableBOM?: boolean, relaxQuotes?: boolean, headerRow?: boolean, includeEmptyCells?: boolean, maxRowCount?: number, range?: string, rawData?: boolean, readAsString?: boolean, sheetName?: string, fromLine?: number, skipRecordsWithErrors?: { value: { enabled?: boolean, maxSkippedRecords?: number } } } | { compression?: boolean, fileName?: string, headerRow?: boolean, sheetName?: string };
