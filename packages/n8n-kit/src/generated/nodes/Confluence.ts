...
export const credentials = [{"name":"confluenceCloudOAuth2Api","required":true,"displayOptions":{"show":{"authentication":["cloudOAuth2"]}}},{"name":"atlassianServiceAccountApi","required":true,"displayOptions":{"show":{"authentication":["serviceAccount"]}}}] as const;
export const inputs = {"main":"main"} as const;
export const outputs = {"main":"main"} as const;

export interface ConfluenceNodeParameters {
    /** Default: "cloudOAuth2" */
    readonly authentication?: "cloudOAuth2" | "serviceAccount";
