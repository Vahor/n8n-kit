...
export interface StripeNodeParameters {
    ...
    /** Default: {} */
    readonly additionalFields?: { description?: string, metadata?: { metadataProperties: { key?: string, value?: string } }, receipt_email?: string, shipping?: { shippingProperties: { name?: string, address?: { details: { line1?: string, line2?: string, city?: string, state?: string, country?: string, postal_code?: string } } } } } | { address?: { details: { line1?: string, line2?: string, city?: string, state?: string, country?: string, postal_code?: string } }, description?: string, email?: string, metadata?: { metadataProperties: { key?: string, value?: string } }, phone?: string, shipping?: { shippingProperties: { name?: string, address?: { details: { line1?: string, line2?: string, city?: string, state?: string, country?: string, postal_code?: string } }, phone?: string } } } | { metadata?: { metadataProperties: { key?: string, value?: string } }, statement_descriptor?: string };
    ...
    /** Default: {} */
    readonly updateFields?: { description?: string, metadata?: { metadataProperties: { key?: string, value?: string } }, receipt_email?: string, shipping?: { shippingProperties: { name?: string, address?: { details: { line1?: string, line2?: string, city?: string, state?: string, country?: string, postal_code?: string } } } } } | { address?: { details: { line1?: string, line2?: string, city?: string, state?: string, country?: string, postal_code?: string } }, description?: string, email?: string, metadata?: { metadataProperties: { key?: string, value?: string } }, name?: string, phone?: string, shipping?: { shippingProperties: { name?: string, address?: { details: { line1?: string, line2?: string, city?: string, state?: string, country?: string, postal_code?: string } }, phone?: string } } };
