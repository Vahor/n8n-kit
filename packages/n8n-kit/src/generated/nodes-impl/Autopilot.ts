 ...
 */
export class Autopilot<L extends string, C extends IContext = never, P extends AutopilotProps = never> extends Node<L, [P] extends [never] ? C : NonNullable<P["outputSchema"]>["infer"]> {
