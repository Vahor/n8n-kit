 ...
 */
export class GitlabTrigger<L extends string, C extends IContext = never, P extends GitlabTriggerProps = never> extends Node<L, [P] extends [never] ? C : NonNullable<P["outputSchema"]>["infer"]> {
