 ...
 */
export class Intercom<L extends string, C extends IContext = never, P extends IntercomProps = never> extends Node<L, [P] extends [never] ? C : NonNullable<P["outputSchema"]>["infer"]> {
