...
export interface McpClientToolProps extends NodeProps, McpClientToolNodeParameters {
...
export class McpClientTool<L extends string> extends Node<L> {
    ...
    constructor(id: L, public readonly props?: McpClientToolProps) {

        super(id, props);

    }

    override getParameters() : Omit<McpClientToolNodeParameters, "httpBearerAuthCredentials | httpHeaderAuthCredentials"> {
