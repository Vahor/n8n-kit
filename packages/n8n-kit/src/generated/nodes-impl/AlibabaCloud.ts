...
import type { AlibabaCloudNodeParameters } from "../nodes/AlibabaCloud";
import { Node, type NodeProps } from "../../nodes/node";
import type { Type } from "arktype";

export interface AlibabaCloudProps extends NodeProps {
    /** {@inheritDoc OutputSchema} */
    readonly outputSchema?: Type;
    readonly parameters?: AlibabaCloudNodeParameters;
    readonly alibabaCloudApiCredentials: Credentials<AlibabaCloudApiCredentials>;
}

/**
 * Interact with Alibaba Cloud Qwen models via Model Studio
 */
