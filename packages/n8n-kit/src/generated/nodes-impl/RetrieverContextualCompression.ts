 ...
 */
export class RetrieverContextualCompression<L extends string, C extends IContext = never, P extends RetrieverContextualCompressionProps = never> extends Node<L, [P] extends [never] ? C : NonNullable<P["outputSchema"]>["infer"]> {
