 ...
 */
export class MistralAi<L extends string, C extends IContext = never, P extends MistralAiProps = never> extends Node<L, [P] extends [never] ? C : NonNullable<P["outputSchema"]>["infer"]> {
