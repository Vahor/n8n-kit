...
export interface ClockifyTriggerProps extends NodeProps, ClockifyTriggerNodeParameters {
...
export class ClockifyTrigger<L extends string> extends Node<L> {
    ...
    constructor(id: L, public readonly props: ClockifyTriggerProps) {

        super(id, props);

    }

    override getParameters() : Omit<ClockifyTriggerNodeParameters, "clockifyApiCredentials"> {
