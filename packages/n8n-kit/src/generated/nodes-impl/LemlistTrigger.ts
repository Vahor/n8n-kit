 ...
 */
export class LemlistTrigger<L extends string, C extends IContext = never, P extends LemlistTriggerProps = never> extends Node<L, [P] extends [never] ? C : NonNullable<P["outputSchema"]>["infer"]> {
