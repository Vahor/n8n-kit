...
import type { KafkaTriggerV1NodeParameters } from "../nodes/KafkaTriggerV1";
import { Node, type NodeProps } from "../../nodes/node";
import type { Type } from "arktype";

export interface KafkaTriggerV1Props extends NodeProps {
    /** {@inheritDoc OutputSchema} */
    readonly outputSchema?: Type;
    readonly parameters?: KafkaTriggerV1NodeParameters;
 ...
 */
export class KafkaTriggerV1<L extends string, C extends IContext = never, P extends KafkaTriggerV1Props = never> extends Node<L, [P] extends [never] ? C : NonNullable<P["outputSchema"]>["infer"]> {
