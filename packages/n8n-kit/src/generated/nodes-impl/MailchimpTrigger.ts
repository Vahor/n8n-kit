 ...
 */
export class MailchimpTrigger<L extends string, C extends IContext = never, P extends MailchimpTriggerProps = never> extends Node<L, [P] extends [never] ? C : NonNullable<P["outputSchema"]>["infer"]> {
