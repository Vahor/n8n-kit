 ...
 */
export class MemoryChatRetriever<L extends string, C extends IContext = never, P extends MemoryChatRetrieverProps = never> extends Node<L, [P] extends [never] ? C : NonNullable<P["outputSchema"]>["infer"]> {
