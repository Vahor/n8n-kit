 ...
 * Sends an Email
 */
export class EmailSendV1<L extends string, C extends IContext = never, P extends EmailSendV1Props = never> extends Node<L, [P] extends [never] ? C : NonNullable<P["outputSchema"]>["infer"]> {
