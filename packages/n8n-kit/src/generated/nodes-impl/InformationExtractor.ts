...
export interface InformationExtractorProps extends NodeProps, InformationExtractorNodeParameters {
...
export class InformationExtractor<L extends string> extends Node<L> {
    ...
    constructor(id: L, public readonly props?: InformationExtractorProps) {

        super(id, props);

    }

    override getParameters() : InformationExtractorNodeParameters {
