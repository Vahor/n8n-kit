 ...
 * LangChain Code Node
 */
export class CodeAI<L extends string, C extends IContext = never, P extends CodeAIProps = never> extends Node<L, [P] extends [never] ? C : NonNullable<P["outputSchema"]>["infer"]> {
