...
export interface ExecuteWorkflowProps extends NodeProps, ExecuteWorkflowNodeParameters {
...
export class ExecuteWorkflow<L extends string> extends Node<L> {
    ...
    constructor(id: L, public readonly props?: ExecuteWorkflowProps) {

        super(id, props);

    }

    override getParameters() : ExecuteWorkflowNodeParameters {
