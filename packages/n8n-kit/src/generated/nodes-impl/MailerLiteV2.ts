 ...
 */
export class MailerLiteV2<L extends string, C extends IContext = never, P extends MailerLiteV2Props = never> extends Node<L, [P] extends [never] ? C : NonNullable<P["outputSchema"]>["infer"]> {
