 ...
 */
export class UrlScanIo<L extends string, C extends IContext = never, P extends UrlScanIoProps = never> extends Node<L, [P] extends [never] ? C : NonNullable<P["outputSchema"]>["infer"]> {
