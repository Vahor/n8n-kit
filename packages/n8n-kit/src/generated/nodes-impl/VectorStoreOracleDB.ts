...
import type { VectorStoreOracleDBNodeParameters } from "../nodes/VectorStoreOracleDB";
import { Node, type NodeProps } from "../../nodes/node";
import type { Type } from "arktype";

export interface VectorStoreOracleDBProps extends NodeProps {
    /** {@inheritDoc OutputSchema} */
    readonly outputSchema?: Type;
    readonly parameters?: VectorStoreOracleDBNodeParameters;
    readonly oracleDbApiCredentials: Credentials<OracleDBApiCredentials>;
}

/**
 * Work with your data in OracleDB vector support
 */
export class VectorStoreOracleDB<L extends string, C extends IContext = never, P extends VectorStoreOracleDBProps = never> extends Node<L, [P] extends [never] ? C : NonNullable<P["outputSchema"]>["infer"]> {
    protected type = "@n8n/n8n-nodes-langchain.vectorStoreOracleDBVector" as const;
