 ...
 */
export class HighLevelV1<L extends string, C extends IContext = never, P extends HighLevelV1Props = never> extends Node<L, [P] extends [never] ? C : NonNullable<P["outputSchema"]>["infer"]> {
