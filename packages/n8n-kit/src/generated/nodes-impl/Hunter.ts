 ...
 * Consume Hunter API
 */
export class Hunter<L extends string, C extends IContext = never, P extends HunterProps = never> extends Node<L, [P] extends [never] ? C : NonNullable<P["outputSchema"]>["infer"]> {
