 ...
 */
export class GoogleContacts<L extends string, C extends IContext = never, P extends GoogleContactsProps = never> extends Node<L, [P] extends [never] ? C : NonNullable<P["outputSchema"]>["infer"]> {
