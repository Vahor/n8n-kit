 ...
 */
export class OpenAiAI<L extends string, C extends IContext = never, P extends OpenAiAIProps = never> extends Node<L, [P] extends [never] ? C : NonNullable<P["outputSchema"]>["infer"]> {
