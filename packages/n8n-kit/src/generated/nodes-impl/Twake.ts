 ...
 * Consume Twake API
 */
export class Twake<L extends string, C extends IContext = never, P extends TwakeProps = never> extends Node<L, [P] extends [never] ? C : NonNullable<P["outputSchema"]>["infer"]> {
