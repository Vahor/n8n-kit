 ...
 * Consume Sendy API
 */
export class Sendy<L extends string, C extends IContext = never, P extends SendyProps = never> extends Node<L, [P] extends [never] ? C : NonNullable<P["outputSchema"]>["infer"]> {
