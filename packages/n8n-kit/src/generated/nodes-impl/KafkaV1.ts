...
import type { KafkaV1NodeParameters } from "../nodes/KafkaV1";
import { Node, type NodeProps } from "../../nodes/node";
import type { Type } from "arktype";

export interface KafkaV1Props extends NodeProps {
    /** {@inheritDoc OutputSchema} */
    readonly outputSchema?: Type;
    readonly parameters?: KafkaV1NodeParameters;
 ...
 */
export class KafkaV1<L extends string, C extends IContext = never, P extends KafkaV1Props = never> extends Node<L, [P] extends [never] ? C : NonNullable<P["outputSchema"]>["infer"]> {
