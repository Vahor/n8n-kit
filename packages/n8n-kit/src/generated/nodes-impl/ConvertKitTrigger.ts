 ...
 */
export class ConvertKitTrigger<L extends string, C extends IContext = never, P extends ConvertKitTriggerProps = never> extends Node<L, [P] extends [never] ? C : NonNullable<P["outputSchema"]>["infer"]> {
