 ...
 */
export class SentimentAnalysis<L extends string, C extends IContext = never, P extends SentimentAnalysisProps = never> extends Node<L, [P] extends [never] ? C : NonNullable<P["outputSchema"]>["infer"]> {
