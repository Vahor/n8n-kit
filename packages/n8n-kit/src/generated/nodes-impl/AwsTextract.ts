...
export interface AwsTextractProps extends NodeProps, AwsTextractNodeParameters {
...
export class AwsTextract<L extends string> extends Node<L> {
    ...
    constructor(id: L, public readonly props: AwsTextractProps) {

        super(id, props);

    }

    override getParameters() : Omit<AwsTextractNodeParameters, "awsCredentials"> {
