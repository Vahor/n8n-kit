 ...
 */
export class MemoryManager<L extends string, C extends IContext = never, P extends MemoryManagerProps = never> extends Node<L, [P] extends [never] ? C : NonNullable<P["outputSchema"]>["infer"]> {
