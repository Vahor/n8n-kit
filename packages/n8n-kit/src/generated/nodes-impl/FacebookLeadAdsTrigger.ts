 ...
 */
export class FacebookLeadAdsTrigger<L extends string, C extends IContext = never, P extends FacebookLeadAdsTriggerProps = never> extends Node<L, [P] extends [never] ? C : NonNullable<P["outputSchema"]>["infer"]> {
