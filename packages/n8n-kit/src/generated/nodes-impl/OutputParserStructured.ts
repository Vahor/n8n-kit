 ...
 */
export class OutputParserStructured<L extends string, C extends IContext = never, P extends OutputParserStructuredProps = never> extends Node<L, [P] extends [never] ? C : NonNullable<P["outputSchema"]>["infer"]> {
