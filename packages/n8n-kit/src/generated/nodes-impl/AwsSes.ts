 ...
 */
export class AwsSes<L extends string, C extends IContext = never, P extends AwsSesProps = never> extends Node<L, [P] extends [never] ? C : NonNullable<P["outputSchema"]>["infer"]> {
