...
// Generated from '/n8n/packages/nodes-base/credentials/GoogleCloudStorageOAuth2Api.credentials.ts' credentials

export const name = "googleCloudStorageOAuth2Api" as const;
...
export interface GoogleCloudStorageOAuth2ApiCredentials {
    ...
    /** Default: "={{$self[\"customScopes\"] ? $self[\"enabledScopes\"] : \"https://www.googleapis.com/auth/cloud-platform https://www.googleapis.com/auth/cloud-platform.read-only https://www.googleapis.com/auth/devstorage.full_control https://www.googleapis.com/auth/devstorage.read_only https://www.googleapis.com/auth/devstorage.read_write\"}}" */
