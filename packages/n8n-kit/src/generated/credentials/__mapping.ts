...
export const searXngApi = "SearXngApi" as const;
export const groqApi = "GroqApi" as const;
export const deepSeekApi = "DeepSeekApi" as const;
export const vercelAiGatewayApi = "VercelAiGatewayApi" as const;
export const xataApi = "XataApi" as const;
export const googlePalmApi = "GooglePalmApi" as const;
export const openRouterApi = "OpenRouterApi" as const;
export const motorheadApi = "MotorheadApi" as const;
export const zepApi = "ZepApi" as const;
export const cohereApi = "CohereApi" as const;
export const azureEntraCognitiveServicesOAuth2Api = "AzureEntraCognitiveServicesOAuth2Api" as const;
export const anthropicApi = "AnthropicApi" as const;
export const weaviateApi = "WeaviateApi" as const;
export const milvusApi = "MilvusApi" as const;
export const pineconeApi = "PineconeApi" as const;
export const wolframAlphaApi = "WolframAlphaApi" as const;
export const huggingFaceApi = "HuggingFaceApi" as const;
export const azureOpenAiApi = "AzureOpenAiApi" as const;
export const serpApi = "SerpApi" as const;
export const xAiApi = "XAiApi" as const;
export const ollamaApi = "OllamaApi" as const;
export const mistralCloudApi = "MistralCloudApi" as const;
export const qdrantApi = "QdrantApi" as const;
