...
// Generated from '/n8n/packages/nodes-base/credentials/MicrosoftGraphSecurityOAuth2Api.credentials.ts' credentials

export const name = "microsoftGraphSecurityOAuth2Api" as const;
