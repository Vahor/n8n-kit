...
// Generated from '/n8n/packages/nodes-base/credentials/GoogleBusinessProfileOAuth2Api.credentials.ts' credentials

export const name = "googleBusinessProfileOAuth2Api" as const;
