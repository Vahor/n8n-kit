...
// Generated from '/n8n/packages/nodes-base/credentials/GoogleCloudNaturalLanguageOAuth2Api.credentials.ts' credentials

export const name = "googleCloudNaturalLanguageOAuth2Api" as const;
