...
// Generated from 'vendor/n8n/packages/nodes-base/nodes/Function/Function.node.ts' node

export const name = "function" as const;
export const description =
	"Run custom function code which gets executed once and allows you to add, remove, change and replace items" as const;
