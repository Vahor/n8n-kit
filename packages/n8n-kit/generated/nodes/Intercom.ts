...
export interface IntercomNodeParameters {
     ...
     * Default: "create"
     */
    readonly operation?: "create" | "delete" | "get" | "getAll" | "update" | "users";
     ...
     * Default: {}
     */
    readonly filters?: { "company_id"?: string, "email"?: string, "segment_id"?: string, "tag_id"?: string, "phone"?: string };

    /**
     * The property to select the user by
     */
    readonly selectBy?: "id" | "userId" | "email" | "phone" | "companyId" | "name";
     ...
     * Default: {}
     */
    readonly additionalFields?: { "avatar"?: string, "companies"?: string[], "email"?: string, "name"?: string, "phone"?: string, "sessionCount"?: number, "userId"?: string, "unsubscribedFromEmails"?: boolean, "updateLastRequestAt"?: boolean, "utmCampaign"?: string, "utmContent"?: string, "utmMedium"?: string, "utmSource"?: string, "utmTerm"?: string, "industry"?: string, "monthlySpend"?: string, "plan"?: string, "size"?: number, "website"?: string };
