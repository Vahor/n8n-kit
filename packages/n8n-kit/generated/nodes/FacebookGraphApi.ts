...
// Generated from 'vendor/n8n/packages/nodes-base/nodes/Facebook/FacebookGraphApi.node.ts' node

export const name = "facebookGraphApi" as const;
export const description =
	"Interacts with Facebook using the Graph API" as const;
