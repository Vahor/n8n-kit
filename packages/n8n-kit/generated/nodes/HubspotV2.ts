...
export interface HubspotV2NodeParameters {
     ...
     * Default: {"mode":"list","value":""}
     */
    readonly dealId?: any | any | any;

    /**
     * Default: {}
     */
    readonly filters?: { "includePropertyVersions"?: boolean, "propertiesCollection"?: { "propertiesValues": any } } | { "includeAssociations"?: boolean, "properties"?: string[], "propertiesWithHistory"?: string[], "propertiesCollection"?: { "propertiesValues": any } } | { "since"?: string, "includePropertyVersions"?: boolean };
