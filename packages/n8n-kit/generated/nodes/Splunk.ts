...
// Generated from '/n8n-nodes-base/dist/nodes/Splunk/Splunk.node.js' node
...
export const credentials = [{"name":"splunkApi","required":true,"testedBy":"splunkApiTest"}] as const

/**
 * Consume the Splunk Enterprise API
 */
export interface SplunkNodeParameters {
     ...
     * Default: "getReport"
     */
    readonly operation?: "getReport" | "delete" | "get" | "getAll" | "create" | "update";
     ...
     * Default: {}
     */
    readonly updateFields?: { "email"?: string, "realname"?: string, "password"?: string, "roles"?: string[] };
