...
export const credentials = [
	{
		...
		testedBy: { request: { method: "GET", url: "/users/me" } },
	},
	{
...
export interface PipedriveNodeParameters {
	 ...
	 */
	readonly filters?: {
		archived_status: "archived" | "all" | "not_archived";
		firstChar: string;
		filterId: string;
		filter_id: string;
		stage_id: string;
		status: "all_not_deleted" | "deleted" | "lost" | "open" | "won";
		user_id: string;
	};
}
