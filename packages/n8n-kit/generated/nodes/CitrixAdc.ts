...
// Generated from '/n8n-nodes-base/dist/nodes/Citrix/ADC/CitrixAdc.node.js' node

export const name = "citrixAdc" as const;
export const description = "Consume Citrix ADC API" as const;
export const version = 1 as const;
export const defaults = {"name":"Citrix ADC"} as const;
export const credentials = [{"name":"citrixAdcApi","required":true}] as const

/**
 * Consume Citrix ADC API
 */
export interface CitrixAdcNodeParameters {
