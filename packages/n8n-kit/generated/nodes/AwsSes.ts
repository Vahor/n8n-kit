...
// Generated from 'vendor/n8n/packages/nodes-base/nodes/Aws/SES/AwsSes.node.ts' node

export const name = "awsSes" as const;
export const description = "Sends data to AWS SES" as const;
export const version = 1 as const;
export const defaults = {"name":"AWS SES"} as const;
...
export interface AwsSesNodeParameters {
     ...
     * Default: "create"
     */
    readonly operation?: "create" | "delete" | "get" | "getAll" | "send" | "update" | "sendTemplate";
     ...
     * Default: {}
     */
    readonly additionalFields?: { "configurationSetName"?: string, "bccAddresses"?: string, "ccAddresses"?: string, "replyToAddresses"?: string, "returnPath"?: string, "returnPathArn"?: string, "sourceArn"?: string, "textPart"?: string };
