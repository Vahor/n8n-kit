...
// Generated from '/n8n-nodes-base/dist/nodes/HighLevel/HighLevel.node.js' node

export const name = "highLevel" as const;
export const description = "Consume HighLevel API" as const;
 ...
 */
export interface HighLevelNodeParameters {
