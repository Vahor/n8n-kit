...
// Generated from 'vendor/n8n/packages/nodes-base/nodes/CrowdDev/CrowdDev.node.ts' node

export const name = "crowdDev" as const;
export const description =
	"crowd.dev is an open-source suite of community and data tools built to unlock community-led growth for your organization." as const;
 ...
 */
export type CrowdDevNodeParameters = {};
