...
// Generated from 'vendor/n8n/packages/nodes-base/nodes/Notion/NotionTrigger.node.ts' node

export const name = "notionTrigger" as const;
export const description =
	"Starts the workflow when Notion events occur" as const;
export const version = 1 as const;
export const defaults = { name: "Notion Trigger" } as const;
