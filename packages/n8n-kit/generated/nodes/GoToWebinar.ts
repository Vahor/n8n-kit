...
export interface GoToWebinarNodeParameters {
     ...
     * Default: "get"
     */
    readonly operation?: "get" | "getAll" | "getDetails" | "create" | "delete" | "getAll" | "reinvite" | "create" | "delete" | "getAll" | "reinvite" | "create" | "delete" | "get" | "getAll" | "get" | "getAll" | "getDetails" | "create" | "get" | "getAll" | "update";
     ...
     */
    readonly webinarKey?: string | string | string | string | string | string | string | string | string | string | string | string | string | string | string | string | string;
     ...
     */
    readonly sessionKey?: string | string;

    /**
     * Registrant key of the attendee at the webinar session
     */
    readonly registrantKey?: string | string | string | string;
     ...
     */
    readonly isExternal?: boolean | boolean | boolean;
     ...
     */
    readonly coorganizerKey?: string | string;
     ...
     */
    readonly panelistKey?: string | string;
