...
// Generated from 'vendor/n8n/packages/nodes-base/nodes/Google/Sheet/GoogleSheetsTrigger.node.ts' node

export const name = "googleSheetsTrigger" as const;
export const description =
	"Starts the workflow when Google Sheets events occur" as const;
...
export interface GoogleSheetsTriggerNodeParameters {
	...
	readonly options?: {
		...
		dataLocationOnSheet: { values: any };
