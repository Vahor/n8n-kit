...
// Generated from 'vendor/n8n/packages/nodes-base/nodes/FacebookLeadAds/FacebookLeadAdsTrigger.node.ts' node

export const name = "facebookLeadAdsTrigger" as const;
export const description =
	"Handle Facebook Lead Ads events via webhooks" as const;
