...
// Generated from 'vendor/n8n/packages/nodes-base/nodes/Google/Gmail/GmailTrigger.node.ts' node
...
export interface GmailTriggerNodeParameters {
     ...
     * Default: {}
     */
    readonly filters?: { "includeSpamTrash"?: boolean, "includeDrafts"?: boolean, "labelIds"?: string[], "q"?: string, "readStatus"?: "both" | "unread" | "read", "sender"?: string };
